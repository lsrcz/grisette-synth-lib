...
trueBranchSketch =
  Component.mkFreshProg
    "trueBranch"
    [IntType, IntType]
    [ Component.freshStmtSimple Sem (return S.Plus),
      Component.freshStmtSimple Sem (return S.Minus)
    ]
    [IntType]
...
sketch =
  flip runFresh "x" $
    Component.mkFreshProg
      ...
      [ Component.freshStmtSimple Sem (return S.Plus),
        Component.freshStmtSimple Sem (return S.Plus),
        Component.freshStmtSimple Sem (return S.Equals),
        Component.freshStmtSimple Sem $
