  ...
  outputs = { self, nixpkgs, flake-utils }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        devShellsWithVersion = { version, cabal, additional }:
          pkgs.mkShell {
            buildInputs = devTools {
              inherit version cabal additional;
            };
      ...
      in
      {
        ...
        devShells = {
          "8107-ci" = devShellsWithVersion { version = "8107"; cabal = false; additional = false; };
          "902-ci" = devShellsWithVersion { version = "902"; cabal = false; additional = false; };
          "928-ci" = devShellsWithVersion { version = "928"; cabal = false; additional = false; };
          "948-ci" = devShellsWithVersion { version = "948"; cabal = false; additional = false; };
          "966-ci" = devShellsWithVersion { version = "966"; cabal = false; additional = false; };
          "984-ci" = devShellsWithVersion { version = "984"; cabal = false; additional = false; };
          "9101-ci" = devShellsWithVersion { version = "9101"; cabal = false; additional = false; };
          "9101-macOS-ci" = devShellsWithVersion { version = "9101"; cabal = false; additional = false; };
          "9121-ci" = devShellsWithVersion { version = "9121"; cabal = true; additional = false; };
          ...
          "984" = devShellsWithVersion { version = "984"; cabal = false; additional = false; };
          "9101" = devShellsWithVersion { version = "9101"; cabal = true; additional = true; };
          default = devShellsWithVersion { version = "9101"; cabal = true; additional = true; };
          "9121" = devShellsWithVersion { version = "9121"; cabal = true; additional = false; };
        };
      });
}
